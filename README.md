...
3. Converted videos will be stored in `script/mjpeg`.
4. Copy converted MJPEG files to the `mjpeg/` folder on the SD card.
5. Adjust value [`MAX_FILES`](https://github.com/schneekluth/locotv/blob/main/locotv.ino#L38) to match the amount of videos copied to the SD card.
6. Reupload code to the board in Arduino IDE.
